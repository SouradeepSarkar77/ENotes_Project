<nav class="navbar navbar-expand-lg navbar-dark bg-custom navbar-custom">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="#"><i class="fa fa-plus-square" aria-hidden="true"></i> Add Notes</a>
      </li>
      <li class="nav-item">
    ...
    <form class="form-inline my-2 my-lg-0">
      ...
      <a href="register.jsp" class="btn btn-light my-2 my-sm-0" type="submit"><i class="fa fa-user-o" aria-hidden="true"></i> Register</a>
    </form>
  </div>
</nav>